...
# Add the SuperSeriousLab registry
...
**Verified install flow** (clean depot, 2026-04-18): General registry + SuperSeriousLab registry → `Pkg.add(["JUI", "FRANK"])` → JUI v0.2.0 + FRANK v0.2.0 installed, JUIFRANKExt auto-activates. ~3 minutes on fresh install (precompilation of Tachikoma substrate).

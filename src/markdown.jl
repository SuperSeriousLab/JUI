# ═══════════════════════════════════════════════════════════════════════
# Markdown extension stubs ── activated by JUIMarkdownExt
#
# The actual implementation lives in ext/JUIMarkdownExt.jl and
...
# Ref hook — set by JUIMarkdownExt.__init__()
...
but not yet imported, this triggers its loading so `JUIMarkdownExt`
...
function enable_markdown()
    ...
    markdown_extension_loaded() ||
        @warn "JUIMarkdownExt did not activate — possible version incompatibility."
    nothing
end
